...
public class V4BConstants {
    ...
    public static double ARM_ANGLE_TRANSFER = 0.8;
    ...
    public static volatile double ARM_MAX_ACC = 0.5;
    public static volatile double ARM_MAX_DEC = 0.1;
    public static volatile double ARM_MAX_VEL = 0.6;
