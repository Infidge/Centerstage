...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 11.45; // X is the up and down direction
    public static double PARALLEL_Y = -6.8; // Y is the strafe direction

    public static double PERPENDICULAR_X = 13;
